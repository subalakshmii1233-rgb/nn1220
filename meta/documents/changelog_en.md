...
- Instalment by Direct debit SEPA, Instalment by Invoice, Direct Debit ACH, MBway, Blik and Payconiq
- Order creation process handled from the shop admin panel

### Enhanced

- Removed due date configuration for Direct debit SEPA with payment guarantee
